...
function NetworkDisplay({
  ...
  if (NETWORKCHECK && localChainId && selectedChainId && localChainId !== selectedChainId) {
    ...
    if (selectedChainId === 31337 && localChainId === 31337) {
      networkDisplay = (
        <div style={{ zIndex: 2, position: "relative", right: 0, top: 50, padding: 16 }}>
          <Alert
    ...
    networkDisplay = USE_NETWORK_SELECTOR ? null : (
      <div style={{ zIndex: -1, position: "absolute", right: 150, top: 80, padding: 16, color: targetNetwork.color }}>
        {targetNetwork.name}
      </div>
    );
  }
